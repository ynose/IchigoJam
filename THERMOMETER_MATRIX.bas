...
31 FOR M=#750 TO #752
32  W=I2CW(#70,M,1,#750,0)
33 NEXT

' Init ADT7410
40 D=#48
41 POKE #760,#00,#01,#02,#03
42 POKE #770,#80
43 W=I2CW(D,#763,1,#770,1)

' Read ADT7410
50 R=I2CR(D,#761,1,#800+16,1)
51 R=I2CR(D,#760,1,#801+16,1)
52 T=[8]/128
...
100 A=T/10:B=T%10
101 FOR L=0 TO 7
102  [L]=PEEK(#700+B*8+L)
103  IF A>0 [L]=[L]|PEEK(#700+A*8+L)<<4
104 NEXT
105 W=I2CW(#70,#753,1,#800,16) 
106 WAIT 60:GOTO 50